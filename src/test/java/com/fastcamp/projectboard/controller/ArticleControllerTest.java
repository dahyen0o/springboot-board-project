...
import com.fastcamp.projectboard.domain.constant.FormStatus;
...
import com.fastcamp.projectboard.dto.request.ArticleRequest;
import com.fastcamp.projectboard.dto.response.ArticleResponse;
import com.fastcamp.projectboard.service.ArticleService;
import com.fastcamp.projectboard.service.PaginationService;
...
// WebMvcTest는 repository를 스캔하지 않음 -> 시큐리티를 통한 유저 인증 실패
// -> TestSecurityConfig로 추가
